...
# Enhanced Self-Attention CNN Transformer model definition
...
# Paths to data directories for stacked inputs
...
torch.save(model.state_dict(), "stack_self_attention_cnn_transformer_model.pth")
print("Model saved as 'stack_self_attention_cnn_transformer_model.pth'")
