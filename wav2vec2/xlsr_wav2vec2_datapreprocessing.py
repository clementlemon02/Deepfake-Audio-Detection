...
# Load feature extractor only (no tokenizer needed for classification tasks)
...
idx = np.random.randint(0, len(audio_rw_train))
sample_audio, attention_mask, label = audio_rw_train[idx]
...
eval_dataset = AudioDataset(val_df)
